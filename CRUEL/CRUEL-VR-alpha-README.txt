...
KNOWN ISSUES:
-In game VR menu (hold primary hand up to head and press trigger) seems not to be working right so avoid it for now. Under investigation.

-Controller remapping only appears to be partially working, in that all VR controls map as intended, but it appears some of the original game's joypad controls remain mapped too. (Example, VR kick button is also triggering melee).  Under investigation.
